...
public final class ActMainBinding implements ViewBinding {
  ...
  @NonNull
  public final GLSurfaceView mGLSurface;

  private ActMainBinding(@NonNull CoordinatorLayout rootView, @NonNull GLSurfaceView mGLSurface) {
  ...
  public static ActMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.mGLSurface;
      GLSurfaceView mGLSurface = ViewBindings.findChildViewById(rootView, id);
      if (mGLSurface == null) {
        break missingId;
      }

      return new ActMainBinding((CoordinatorLayout) rootView, mGLSurface);
    }
